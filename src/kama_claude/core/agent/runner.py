"""Wires one run together: run id, run directory, event sinks, tools, provider."""
...
async def run_goal(
    ...
    *,
    ...
    """Run one goal to completion. Returns the result and the run directory."""
    run_id = new_run_id()
    run_dir = (workspace / settings.runs_dir / run_id).resolve()
